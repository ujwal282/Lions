...
const ClusterHead_DeputyHead = () => {
  const {t} = useTranslation();
  return (
    <section className='flex justify-center items-center flex-col p-10 pt-52'>
      <h1 className='text-4xl text-heading mb-3'>{t("header.teams.cabinet-officials.cluster-head")}</h1>
...
export default ClusterHead_DeputyHead